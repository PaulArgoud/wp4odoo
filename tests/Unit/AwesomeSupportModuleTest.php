...
/**
 * Unit tests for Awesome_Support_Module.
 *
 ...
 */
class AwesomeSupportModuleTest extends TestCase {
	...
	public function test_module_id_is_awesome_support(): void {
		$this->assertSame( 'awesome_support', $this->module->get_id() );
	}

	public function test_module_name(): void {
		$this->assertSame( 'Awesome Support', $this->module->get_name() );
	}
	...
	public function test_dependency_available_when_constant_defined(): void {
		...
		// WPAS_VERSION is defined in test stubs.
